	...
	public class Time
	{
		public static void main(String[] args) 
		{
			...
			String time = JOptionPane.showInputDialog(null,
				"Enter a time in the format hh:mm:ss:lll", "Enter Time",
			...
			catch(StringIndexOutOfBoundsException e)
			{
				JOptionPane.showMessageDialog(null,
						...
						"Please enter the time in the form hh:mm:ss:lll",
		...
		public static int getTotalSeconds(String time)throws NumberFormatException, StringIndexOutOfBoundsException {
			...
			//we will eventually multiply the hours by 3600 + the minutes by 60 + the seconds + the milliseconds
